...
::ndk::ScopedAStatus UdfpsHelper::registerCallback(const std::shared_ptr<::aidl::vendor::oplus::hardware::syshelper::IUdfpsHelperCallback>& callback) {
    if (callback == nullptr) {
...
::ndk::ScopedAStatus UdfpsHelper::unregisterCallback(const std::shared_ptr<::aidl::vendor::oplus::hardware::syshelper::IUdfpsHelperCallback>& in_callback) {
