...
#include <aidl/vendor/oplus/hardware/syshelper/BnUdfpsHelper.h>
...
class UdfpsHelper : public BnUdfpsHelper {
   public:
    ...
    ::ndk::ScopedAStatus registerCallback(const std::shared_ptr<::aidl::vendor::oplus::hardware::syshelper::IUdfpsHelperCallback>& in_callback) override;
    ::ndk::ScopedAStatus unregisterCallback(const std::shared_ptr<::aidl::vendor::oplus::hardware::syshelper::IUdfpsHelperCallback>& in_callback) override;
